...
# SCRIPT PARA OBTENER INFORMACIÓN SOBRE LAS COMUNIDADES Y LOS NODOS MÁS 
# IMPORTANTES DE UN GRAFO DE ESPECIES Y PARA SU REPRESENTACIÓN GRÁFICA.

# Toma como entrada una lista de adyacencia de un grafo de especies y el 
# el registro de la población de árboles correspondiente.
# Ofrece información sobre la proporción de individuos y el grado de cada
# especie, así como el nombre de sus especies vecinas.
# Aplica el algoritmo de Louvain para detección de comunidades.
# Muestra las especies más importantes en base a su centralidad en cada 
# comunidad.
# Representa el grafo completo con números que identifican a las especies.
...
# Antes de crear el grafo, se obtiene información sobre el número de individuos
# de cada especie de la población. Para ello, se lee el registro.
...
# Centralidad de intermediación de cada vértice (absoluta, no normalizada)
