...
list.of.packages <- c("kableExtra","Imap","ggplot2","dplyr","sqldf", "igraph", "ggraph", "shinyBS", "shinydashboard",
...
# Se crea el grafo a partir de una lista de adyacencia por ejemplo.
